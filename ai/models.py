...
class TransaccionExtraida(BaseModel):
    comercio:   str            = Field(description="Nombre del comercio o destinatario de la transacción")
    ...
    categoria:  Categoria      = Field(description="Categoría del gasto basada en el comercio")
